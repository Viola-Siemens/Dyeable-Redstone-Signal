...
public class DRSBlockEntities {
	...
	public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<CommonRedstoneWireBlockEntity>> COMMON_REDSTONE_WIRE = REGISTER.register(
	...
	public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<CommonRedstoneRepeaterBlockEntity>> COMMON_REDSTONE_REPEATER = REGISTER.register(
	...
	public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<RedstoneDyerBlockEntity>> REDSTONE_DYER = REGISTER.register(
